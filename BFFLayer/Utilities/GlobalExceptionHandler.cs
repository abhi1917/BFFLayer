...
namespace BFFLayer.Utilities
{
    public class GlobalExceptionHandler:ExceptionHandler
    {
        ...
        public override void Handle(ExceptionHandlerContext context)
        {
            ...
            {
                Content = new StringContent(ApiResource.ErrorMessage + context.Request.Headers.GetValues(ApiResource.TransactionId).FirstOrDefault() + context.Exception.Message),
                ReasonPhrase = ErrorMessages.Exception
            };
